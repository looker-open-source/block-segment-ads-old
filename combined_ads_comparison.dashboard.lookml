- dashboard: facebook__adwords_comparison
  ...
  - name: Clicks Breakdown
    ...
    type: looker_pie
    fields:
    - combined_ads_compare.source
    - combined_ads_compare.clicks
    sorts:
    - combined_ads_compare.clicks desc
    limit: 500
    column_limit: 50
    value_labels: legend
    label_type: labPer
  ...
  - name: Impressions Breakdown
    ...
    fields:
    - combined_ads_compare.source
    - combined_ads_compare.impresssions
    sorts:
    - combined_ads_compare.impresssions desc
    limit: 500
    column_limit: 50
    value_labels: legend
    label_type: labPer
  ...
  - name: Spend Breakdown
    ...
    fields:
    - combined_ads_compare.source
    - combined_ads_compare.spend
    sorts:
    - combined_ads_compare.spend desc
    limit: 500
    column_limit: 50
    value_labels: legend
    label_type: labPer
  ...
  - name: Spend and CPC
    ...
    - combined_ads_compare.source
    - combined_ads_compare.spend
    - combined_ads_compare.cost_per_click
    sorts:
    - combined_ads_compare.cost_per_click desc
    limit: 500
    column_limit: 50
    stacking: ''
    show_value_labels: false
    ...
    - label: ''
      ...
      valueFormat:
      series:
      - id: combined_ads_compare.cost_per_click
  ...
  - name: Campaign Overview
    ...
    type: table
    fields:
    - combined_ads_compare.campaign_name
    - combined_ads_compare.impresssions
    - combined_ads_compare.clicks
    - combined_ads_compare.spend
    - combined_ads_compare.cost_per_click
    ...
    - label: ''
      ...
      - id: combined_ads_compare.cost_per_click
        name: Ads Compare Cost per Click
    series_labels:
      combined_ads_compare.count: Count Ads
    row: 9
    col: 12
    width: 12
    height: 7
  ...
  - name: Overall Campaign Count
    ...
    type: single_value
    fields:
    - combined_ads_compare.count_campaigns
    limit: 500
    column_limit: 50
    custom_color_enabled: false
    custom_color: forestgreen
  ...
  - name: Ad Performance
    ...
    - label:
      ...
      valueFormat:
      series:
      - id: combined_ads_compare.clicks
        name: Clicks
    row: 18
    col: 15
    width: 9
